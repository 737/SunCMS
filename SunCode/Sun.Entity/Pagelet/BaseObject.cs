...
namespace Sun.Entity.Pagelet
{
    ...
    public class BaseObject
    {
        ...
        public static T getClone<T>(T t)
        {
            ...
            object newObject = Activator.CreateInstance(_this.GetType());
            ...
            foreach (FieldInfo fi in _this.GetType().GetFields())
            {
                ...
                if (ICloneType != null)
                {
                    ...
                    ICloneable IClone = (ICloneable)fi.GetValue(_this);
                ...
                else
                {
                    ...
                    fields[i].SetValue(newObject, fi.GetValue(_this));
                ...
                if (IEnumerableType != null)
                {
                    ...
                    IEnumerable IEnum = (IEnumerable)fi.GetValue(_this);
